...
source.include_exts = py,png,jpg,kv,atlas,json,ttf,gif,zip
...
presplash.filename = Images/load_screen/load_screen.png

# (str) Icon of the application
icon.filename = Images/icon/icon.png
